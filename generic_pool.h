...
typedef void * (* generic_pool_alloc_thing_fn)(generic_pool_t * pool, void * v, va_list args);
// cb to delete (or unref) a thing
typedef void (* generic_pool_delete_thing_fn)(generic_pool_t * pool, void * v, void * const thing);
// can we reuse this thing for this get request?
// -1  => No
//  0  => Yes
// +ve => Choose thing with lowest +ve score from those in pool (0 is simple case)
typedef int (* generic_pool_try_reuse_thing_fn)(generic_pool_t * pool, void * v, void * dfb, va_list args);
...
void generic_pool_put(generic_pool_t * pool, void * thing);
